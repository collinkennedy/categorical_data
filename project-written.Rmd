...
inter_plot = ggplot(data = heart_disease_data,mapping = aes(x = inter,y = visits) )+
  ...
  scale_y_continuous("# of Visits")+
  ggtitle("No. of Visits and No. of Interventions")
inter_plot
...
drug_plot = ggplot(data = heart_disease_data,mapping = aes(x = drugs,y = visits) )+
  ...
  scale_y_continuous("# of Visits")+
  ggtitle("No. of Visits and No. of Drugs Prescribed")
drug_plot
...
complications_plot = ggplot(data = heart_disease_data,mapping = aes(x = complications,y = visits) )+
  ...
  scale_y_continuous("# of Visits")+
  ggtitle("No. of Visits and No. of Complications")
...
comorbidities_plot = ggplot(data = heart_disease_data,mapping = aes(x = comorbidities,y = visits) )+
  ...
  scale_y_continuous("# of Visits")+
  ggtitle("No. of Visits and No. of Comorbidities")
comorbidities_plot
...
```{r}
cost_plot_trans = ggplot(data = heart_disease_data,mapping = aes(x = cost,y = log(visits)))+
  geom_point(fill = "cadetblue3", colour = "cadetblue4")+
  scale_y_continuous("# of Visits")+
  ggtitle("No. of Visits and Cost")
...
#age
age_plot_trans = ggplot(data = heart_disease_data,mapping = aes(x = age,y = log(visits)) )+
  geom_point(fill = "deeppink4", colour = "deeppink4")+
  scale_y_continuous("# of Visits")+
  ggtitle("No. of Visits and Age")
...
#inter
inter_plot_trans = ggplot(data = heart_disease_data,mapping = aes(x = inter,y = log(visits)))+
  geom_point(fill = "mediumorchid4", colour = "mediumorchid4")+
  scale_y_continuous("# of Visits")+
  ggtitle("No. of Visits and No. of Interventions")
inter_plot_trans
...
#drugs
drug_plot_trans = ggplot(data = heart_disease_data,mapping = aes(x = drugs,y = log(visits)))+
  geom_point(fill = "orange1", colour = "orange1")+
  scale_y_continuous("# of Visits")+
  ggtitle("No. of Visits and No. of Drugs Prescribed")
drug_plot_trans
...
#complications
complications_plot_trans = ggplot(data = heart_disease_data,mapping = aes(x = complications,y = log(visits)))+
  geom_boxplot(fill = "orange1", colour = "red4",aes(group = complications))+
  scale_y_continuous("# of Visits")+
  ggtitle("No. of Visits and No. of Complications")
...
#comorbidities
comorbidities_plot_trans = ggplot(data = heart_disease_data,mapping = aes(x = comorbidities,y = log(visits)) )+
  geom_point(fill = "orange1", colour = "purple2")+
  scale_y_continuous("# of Visits")+
  ggtitle("No. of Visits and No. of Comorbidities")
comorbidities_plot_trans
